...
const source = 'statsCommonName';

export const LOAD_REQUESTED_COMMON_NAME = createAction(
  `[${source}] load request `,
  props<{commonName: string,dateStart: string,dateEnd: string}>()
)
