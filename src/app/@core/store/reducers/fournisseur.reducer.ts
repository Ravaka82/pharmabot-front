...
import {Entry} from "src/app/@core/interfaces/fournisseur.interface";
import {createReducer, on} from "@ngrx/store";
import {FournisseurState as State} from '../states';
import {AccountActions, FournisseurActions as ModelActions} from '../actions';
...
export const reducer = createReducer(
  ...
  on(AccountActions.LOGOUT_SUCCEED, _ => {
    console.log('initialize fournisseur state.');
