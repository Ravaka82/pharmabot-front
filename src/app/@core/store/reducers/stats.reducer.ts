...
import {Entry} from "src/app/@core/interfaces/stats.interface";
import {createReducer, on} from "@ngrx/store";
import {StatsState as State} from '../states';
import {AccountActions, StatsActions as ModelActions} from '../actions';
...
export const reducer = createReducer(
  initialState,
  on(
    ModelActions.LOAD_REQUESTED_DESIGNATION,
